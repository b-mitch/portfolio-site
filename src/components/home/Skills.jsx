    ...
    return (
        <div id="skills" className="skills">
          ...
          <div className="logo-container">
            ...
            <div dataIframeWidth="150" dataIframeHeight="270" dataShareBadgeId="f7dd5387-7045-4b53-9e6f-b1260bde9380" dataShareBadgeHost="https://www.credly.com"></div><script type="text/javascript" async src="//cdn.credly.com/assets/utilities/embed.js"></script>
